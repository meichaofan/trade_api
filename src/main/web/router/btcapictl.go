...
func GetPlatformList(c *gin.Context) {
	...
	var exchangeTickers []*data.ExchangeTicker
	var exchangeAmountList []*data.ExchangeAmount
	...
	for _, platform := range platforms {
		...
		exchangeAmountList = append(exchangeAmountList, exchangeAmount)
	}

	//根据order参数，对exchangeAmountList进行排序
	common.Sort(exchangeAmountList, order)
